...
public interface LabeledExprListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link LabeledExprParser#func}.
	 * @param ctx the parse tree
	 */
	void enterFunc(LabeledExprParser.FuncContext ctx);
	/**
	 * Exit a parse tree produced by {@link LabeledExprParser#func}.
	 * @param ctx the parse tree
	 */
	void exitFunc(LabeledExprParser.FuncContext ctx);
}