...
public class LabeledExprParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, T__2=3, MUL=4, DIV=5, ADD=6, SUB=7, FACT=8, SIN=9, COS=10, 
		TAN=11, SQRT=12, LN=13, LOG=14, ID=15, INT=16, NEWLINE=17, WS=18;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, null, "MUL", "DIV", "ADD", "SUB", "FACT", "SIN", "COS", 
			"TAN", "SQRT", "LN", "LOG", "ID", "INT", "NEWLINE", "WS"
		};
	}
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 261636L) != 0) );
			}
		}
	...
	public static class FuncContext extends ParserRuleContext {
		...
		public TerminalNode TAN() { return getToken(LabeledExprParser.TAN, 0); }
		...
		public TerminalNode LOG() { return getToken(LabeledExprParser.LOG, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LabeledExprListener ) ((LabeledExprListener)listener).enterFunc(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LabeledExprListener ) ((LabeledExprListener)listener).exitFunc(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
